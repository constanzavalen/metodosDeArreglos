...
const nombreTareasIniciales = ['Hacer mercado','Estudiar para la prueba', 'Sacar a pasear al perro'];
...
function agregarHtmlTareaATabla({id, nombre, estado}) {
    let html = `
        <tr id="${id}">
            ...
            <td> 
            <button type="button" onclick="eliminar(${id})" class="btn btn-success">Eliminar</button>
            </td>
        </tr>   
    `
